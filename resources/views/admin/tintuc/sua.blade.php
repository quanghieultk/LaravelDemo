                ...
                <tbody>
                    @foreach($tintuc->comment as $cm)
                        <tr class="odd gradeX" align="center">
                            ...
                            <td>{{$cm->NoiDung}}</td>
                            <td>{{$cm->created_at}}</td>
                            <td class="center"><i class="fa fa-trash-o  fa-fw"></i><a href="admin/comment/xoa/{{$cm->id}}/{{$tintuc->id}}"  onclick="return confirm('Bạn có chắc chắn muốn xóa không');"> Delete</a></td>
                        </tr>
                        @endforeach
                </tbody>
            </table>
